...
existing_plot <- ggplot(mtcars) + geom_point(aes(wt,mpg)) + labs(title = 'TITLE',subtitle='Subtitle')

# Save your theme settings as an object ('my_theme')
my_theme <- theme(plot.title = element_text(size=25, family = 'Urbanist', face = 'bold', color = 'blue'),
