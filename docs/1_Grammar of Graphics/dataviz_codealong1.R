...
ggplot(mtcars) +
  geom_smooth(aes(x = wt, y = mpg), method = "lm", linetype = 2)


## 3.2 Linetype as mapped aesthetic ----
ggplot(mtcars) +
  geom_smooth(aes(x = wt, y = mpg, linetype = as.factor(cyl)), method = "lm")


## 3.3 Shape as global aesthetic ----
ggplot(mtcars) +
  geom_point(aes(x = wt, y = mpg), shape = 2)


## 3.4 Shape as mapped aesthetic ----
ggplot(mtcars) +
  geom_point(aes(x = wt, y = mpg, shape = as.factor(cyl)))
